...
import cn.zm.tk.webbck.entity.dto.AccountDTO;
import cn.zm.tk.webbck.entity.vo.AccountVO;
...
public class AccountController extends BaseController {
    ...
    public ResponseResult del(@PathVariable String id) {
        ...
        account.setId(new Integer(id));
        accountService.deleteById(account);
