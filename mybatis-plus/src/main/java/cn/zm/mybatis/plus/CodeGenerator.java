...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        ClassPathResource app = new ClassPathResource("mybatis-plus.yml");
    ...
    private static void genDO(String[] tables, ClassPathResource... apps) {
        ...
        // 公共父类
        strategy.setSuperControllerClass("cn.zm.mybatis.plus.config.BaseController");
        // 写于父类中的公共字段
