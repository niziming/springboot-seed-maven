...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        ClassPathResource app = new ClassPathResource("application.yml");
        ...
        ClassPathResource[] apps = new ClassPathResource[]{app, dev, prod};
        genDO(tables, apps);
        genDTO(tables, apps);
        genVO(tables, apps);
    }
    ...
    private static void genDO(String[] tables, ClassPathResource... apps) {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/core/src/main/resources/mapper/"
        ...
        // 公共父类
        strategy.setSuperControllerClass("cn.zm.common.BaseController");
        // 写于父类中的公共字段
    ...
    private static void genDTO(String[] tables, ClassPathResource... apps) {
        YamlPropertiesFactoryBean factoryBean = new YamlPropertiesFactoryBean();
        factoryBean.setResources(apps);
        Properties object = factoryBean.getObject();
        String driver = object.getProperty("spring.datasource.driver-class-name");
    ...
    private static void genVO(String[] tables, ClassPathResource... apps) {
        YamlPropertiesFactoryBean factoryBean = new YamlPropertiesFactoryBean();
        factoryBean.setResources(apps);
        Properties object = factoryBean.getObject();
        String driver = object.getProperty("spring.datasource.driver-class-name");
